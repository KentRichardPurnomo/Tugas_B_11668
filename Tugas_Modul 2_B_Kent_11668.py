...
model_path = r'D:\Atma\Sem 5\Pembelajaran Mesin\P3\Tugas_B_11668'
...
st.write("Aplikasi ini berguna untuk menilai pontensi penyakit jantung")
...
Cholestrol = st.number_input("Cholesterol",0.63)
FastingBS = st.selectbox("Festing BS",["1","0"])
RestingECG = st.selectbox("Resting ECG",["LVH","Normal","ST"])
MaxHR = st.number_input("Max Heart Rate",60,202)
ExcerciseAngina = st.radio("Escercise Angina",["N","Y"])
...
input_data = [[input_sex_F,input_sex_M,input_cpain_ASY,
               ...
               RestingBP,Cholestrol,input_fastbs,MaxHR,Old_peak]]
...
if st.button("Prediksi"):
    ...
    outcame={0: 'Tidak Berpotensi sakit jantung', 1: 'Berpotensi sakit jantung'}
    st.write(f"Orang tersebut diprekdiksi ** {outcame[rf_model_prediction[0]]}**")